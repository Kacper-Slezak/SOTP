...
try:
    ...
    print(f"Błąd importu! Upewnij się, że test jest uruchamiany z głównego katalogu 'backend'.")
    print(e)
    exit(1)
...
class TestDeviceICMPTask(unittest.TestCase):
    ...
    def test_device_icmp_success_up(self, mock_ping):
        ...
        print("--- ✅ ZAKOŃCZONO: test_device_icmp_success_up -Testuje 'device_icmp' dla pomyślnego pingu (status UP). ---")
    ...
    def test_device_icmp_success_down(self, mock_ping):
        ...
        print("--- ✅ ZAKOŃCZONO: test_device_icmp_success_down -Testuje 'device_icmp' dla nieudanego pingu (status DOWN). ---")
    ...
    def test_device_icmp_bad_ip_format(self, mock_ping):
        ...
        print("--- ✅ ZAKOŃCZONO: test_device_icmp_bad_ip_format -Testuje 'device_icmp' dla złego formatu IP (np. domeny). ---")
...
class TestScheduleAllPingsTask(unittest.TestCase):
    ...
    def test_schedule_pings_active_only(self, mock_get_all_devices, mock_delay):
        ...
        print("--- ✅ ZAKOŃCZONO: test_schedule_pings_active_only -Testuje, czy domyślnie kolejkowane są tylko AKTYWNE urządzenia. ---")
    ...
    def test_schedule_pings_all_devices(self, mock_get_all_devices, mock_delay):
        ...
        print("--- ✅ ZAKOŃCZONO: test_schedule_pings_all_devices -Testuje, czy 'only_active=False' kolejkuje WSZYSTKIE urządzenia. ---")
    ...
    def test_schedule_pings_no_devices_found(self, mock_get_all_devices, mock_delay):
        ...
        print("--- ✅ ZAKOŃCZONO: test_schedule_pings_no_devices_found -Testuje, co się dzieje, gdy 'get_all_devices' zwraca pustą listę. ---")
    ...
    def test_schedule_pings_database_error(self, mock_get_all_devices):
        ...
        print("--- ✅ ZAKOŃCZONO: test_schedule_pings_database_error -Testuje, czy błąd bazy danych jest poprawnie łapany. ---")
